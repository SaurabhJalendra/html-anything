...
Usage:
  ...
  html-anything <input> --style STYLE       auto, teaching, interactive-learning, dashboard, ...
...
(teaching, interactive-learning, relationship, dashboard, timeline-story,
map-atlas, network-map, document, developer, or default) based on the parsed
content type.
`
